      ...
      <div className="grid grid-cols-2 w-11/12 mx-auto justify-items-center gap-12 my-10">
        ...
        >
          ...
          <div className="flex flex-col justify-between p-4 leading-normal">
            ...
            <a
              href="#"
              class="flex justify-center w-32 px-3 py-2 text-sm font-medium text-white button-clr-primary rounded-lg hover:bg-blue-800  dark:bg-blue-600 dark:hover:bg-blue-700"
            >
              Join now
              <svg
                aria-hidden="true"
